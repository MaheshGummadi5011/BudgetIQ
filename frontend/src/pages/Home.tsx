...
const Home = () => {
  ...
  return (
    <div className="min-h-screen ">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800">
        <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-400 via-cyan-500 to-blue-600"></div>
        <div className="max-w-7xl mx-auto">
          <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <div className="inline-flex items-center px-4 py-1.5 mb-4 rounded-full bg-teal-100 dark:bg-teal-900/30 border border-teal-200 dark:border-teal-800">
                  <span className="text-xs font-medium text-teal-600 dark:text-teal-300">Powered by AI</span>
                </div>
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                  <span className="block">Your AI-Powered</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-cyan-500 to-blue-600">Investment Partner for Indian Markets!</span>
                </h1>
                ...
                <div className="mt-8 sm:mt-10 sm:flex sm:justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link to="/sign-up" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 border border-transparent text-base font-medium rounded-lg text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 shadow-lg hover:shadow-xl transition-all duration-300">
                    Get Started
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                  <Link to="/portfolio/learn" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 border border-teal-200 dark:border-teal-800 text-base font-medium rounded-lg text-teal-700 dark:text-teal-300 bg-white dark:bg-gray-800 hover:bg-teal-50 dark:hover:bg-gray-700 shadow-md hover:shadow-lg transition-all duration-300">
                    Learn More
                  </Link>
                </div>
                ...
                <div className="mt-10 pt-6 grid grid-cols-3 gap-6 border-t border-gray-200 dark:border-gray-700">
                  <div>
                    <p className="text-3xl font-bold text-teal-600 dark:text-teal-400">₹10Cr+</p>
                  ...
                  <div>
                    <p className="text-3xl font-bold text-teal-600 dark:text-teal-400">5000+</p>
       ...
       {/* Features Section */}
       {/* Features Section */}
       <div className="py-12 bg-teal-50 dark:bg-gray-800">
              ...
              {features.map((feature, index) => (
                <div key={index} className="pt-6">
                  <div className="flow-root bg-white dark:bg-gray-800 rounded-lg px-6 pb-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="-mt-6">
                      <div className="inline-flex items-center justify-center p-3 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-md shadow-lg">
                        {feature.icon}
                      </div>
